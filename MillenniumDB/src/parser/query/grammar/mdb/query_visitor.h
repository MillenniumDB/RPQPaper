...
public:
    ...
    virtual antlrcpp::Any visitPath(MDBParser::PathContext* ctx) override {
        ...
        PathSemantic semantic = PathSemantic::ALL_SHORTEST;
        if (ctx->pathType() == nullptr) {
            ...
            if (semantic_str == "any") {
                semantic = PathSemantic::ANY;
            } else if (semantic_str == "any_simple") {
                semantic = PathSemantic::ANY_SIMPLE;
            } else if (semantic_str == "simple") {
                semantic = PathSemantic::SIMPLE;
            } else if (semantic_str == "any_trails") {
                semantic = PathSemantic::ANY_TRAILS;
            } else if (semantic_str == "trails") {
                semantic = PathSemantic::TRAILS;
            } else if (semantic_str == "any_acyclic") {
                semantic = PathSemantic::ANY_ACYCLIC;
            } else if (semantic_str == "acyclic") {
                semantic = PathSemantic::ACYCLIC;
            } else if (semantic_str == "all_count") {
                semantic = PathSemantic::ALL_COUNT;
            } else if (semantic_str == "all_shortest_acyclic") {
                semantic = PathSemantic::ALL_SHORTEST_ACYCLIC;
            } else if (semantic_str == "all_shortest_simple") {
                semantic = PathSemantic::ALL_SHORTEST_SIMPLE;
            } else if (semantic_str == "all_shortest_trails") {
